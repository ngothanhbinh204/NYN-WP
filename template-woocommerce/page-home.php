	...
	<section class="home-2 relative section-py !pb-0">
		<div class="container-160">
					...
					<?php while (have_rows('home_2_items')): the_row();
						...
						<div class="item flex items-center justify-center flex-col">
							...
							<div class="content text-center">
								<div class="title heading-5 font-bold font-secondary text-Utility-Black"><?php echo esc_html($title); ?></div>
							</div>
						</div>
					<?php endwhile; ?>
				<?php endif; ?>
			...
			<div class="wrapper-content text-center xl:my-20 my-10 mx-auto">
				<h2 class="title xl:rem:text-[80px] rem:text-[48px] block-title font-extrabold text-Utility-Black"><?php echo esc_html(get_field('home_2_main_title') ?: 'Lối sống, được chọn lọc.'); ?></h2>
...
<section class="home-3">
            ...
            <?php if (!empty($sections)): ?>
                ...
                ?>
                    <div class="wrapper-inner flex items-center md:even:flex-row-reverse md:flex-row flex-col">
                        <div class="col-left md:rem:w-[960px] w-full" 
                             data-aos="fade-right" 
                             data-aos-delay="100" 
                             data-aos-duration="800" 
                             stick-to-edge="<?php echo $stick_edge; ?>" 
                             unstick-min="1024">
                            <div class="img">
                                <a class="img-ratio ratio:pt-[640_960] zoom-img" href="<?php echo $btn_url; ?>">
                                    <img class="lozad" data-src="<?php echo $img_url; ?>" alt="<?php echo $img_alt; ?>" />
                                </a>
                            </div>
                        </div>
                        <div class="col-right flex-1 w-full" 
                             data-aos="fade-left" 
                             data-aos-delay="200" 
                             data-aos-duration="800">
                            ...
                            <div class="wrap-content-bottom">
                                <?php if ($button): ?>
                                    <div class="button-more mt-8">
                                        <a class="btn btn-primary" href="<?php echo $btn_url; ?>" target="<?php echo $btn_target; ?>">
	...
	<section class="home-4 xl:py-24 xl:!pb-0 py-10">
		<div class="container">
			<h2 class="title block-title heading-1 font-semibold text-center mb-8"><?php echo esc_html(get_field('home_4_title') ?: 'Những cảm nhận từ cộng đồng NYN'); ?></h2>
								...
								<div class="swiper-slide">
									<div class="item bg-Utility-50 xl:py-16 xl:px-7 p-4 bpd-1 text-center">
										...
										<div class="content-bottom mt-8 flex flex-col gap-1">
											<div class="info body-1 font-secondary font-bold"><?php echo esc_html($info); ?></div>
	...
	<section class="home-5 section-py">
		<div class="container">
			<h2 class="title block-title heading-1 font-semibold text-center mb-8"><?php echo esc_html(get_field('home_5_title') ?: 'Sản phẩm được chọn lọc'); ?></h2>
			...
			<div class="sub-title mt-base xl:rem:h-[52px] p-2 bg-Utility-Black flex-center text-white font-secondary body-2 font-normal" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
	...
	<section class="home-6 section-py !pt-0">
		<div class="container">
			<h2 class="block-title heading-1 font-extrabold text-center mb-8"><?php echo esc_html(get_field('home_promotion_title') ?: 'Khuyến mãi đang diễn ra'); ?></h2>
				...
				<div class="col-left">
					<div class="img"> 
						<a class="img-ratio ratio:pt-[466_700]" href="#">
							...
							<?php if ($p_img): ?>
								<img class="lozad" data-src="<?php echo esc_url($p_img['url']); ?>" alt="<?php echo esc_attr($p_img['alt']); ?>" />
							<?php else: ?>
									...
									<?php while (have_rows('home_promotion_slider')): the_row(); 
										...
										<div class="swiper-slide">
											<div class="wrap-content">
												<div class="wrap-content-top">
													<h2 class="title heading-1 font-extrabold mb-5"><?php echo esc_html($title); ?></h2>
													<div class="format-content body-2 font-normal text-Utility-Black font-secondary mb-base">
														<p><?php echo esc_html($desc); ?></p>
													</div>
												</div>
												<div class="wrap-content-bottom">
													<div class="button-more">
														<button class="btn btn-primary" onclick="window.location.href='<?php echo esc_url($button_promotion_url); ?>'"><span><?php echo esc_html($button_promotion_title ?: 'Xem chi tiết'); ?></span></button>
													</div>
												</div>
											</div>
										</div>
	...
	<section class="home-7 xl:rem:pb-[96px] pb-10">
		<div class="container">
			<h2 class="title block-title heading-1 font-semibold text-center mb-8"><?php echo esc_html(get_field('home_6_title') ?: 'Cam kết từ NYN'); ?></h2>
					...
					<?php $delay = 0; while (have_rows('home_6_items')): the_row();
						...
						<div class="item flex items-center justify-center flex-col text-center" data-aos="fade-up" data-aos-delay="<?php echo $delay; ?>" data-aos-duration="1000">
							...
							<div class="content mt-8 xl:px-12">
								<div class="title heading-5 font-bold font-secondary"><?php echo esc_html($title); ?></div>
							</div>
						</div>
...
<section class="home-8 overflow-hidden xl:rem:py-[49px] pt-10">
    <div class="container">
        <div class="wrapper grid md:grid-cols-2 grid-cols-1">
            <div class="col-left item-slide-left xl:rem:pr-[120px]" data-aos="fade-right" data-aos-delay="100" data-aos-duration="800">
                <div class="content text-center">
                    <div class="content-top">
                        <div class="wrap-heading">
                            <h3 class="title heading-1 font-extrabold mb-8"><?php echo esc_html($left_heading); ?></h3>
                            <div class="desc body-2 font-secondary font-normal">
                                <p><?php echo wp_kses_post($left_desc); ?></p>
                            </div>
                        </div>
                        <div class="wrap-bottom mt-8">
                            <div class="title heading-5 font-normal font-secondary"><?php echo esc_html($left_quote); ?></div>
                                ...
                                <?php if (!empty($left_contacts)): ?>
                                    <?php foreach ($left_contacts as $contact): 
                                        ...
                                        <div class="item flex items-center gap-2 text-Utility-Black font-bold">
                                            <div class="icon">
                                                <i class="fa<?php echo $is_brand ? '-brands' : '-solid'; ?> fa-<?php echo esc_attr($icon); ?>"></i>
                                            </div>
            ...
            <div class="col-right" data-aos="fade-left" data-aos-delay="200" data-aos-duration="800">
                <div class="content text-center">
                    <div class="content-top">
                        <div class="wrap-heading">
                            <h3 class="title heading-1 font-extrabold mb-8"><?php echo esc_html($right_heading); ?></h3>
                            <div class="desc body-2 font-secondary font-normal">
