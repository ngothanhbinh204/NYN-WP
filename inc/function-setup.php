...
add_action('wp_enqueue_scripts', 'canhcam_style', 99999);
...
{ ?>
	<style type="text/css">
		#login h1 a,
		.login h1 a {
			background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/logo-1.png);
			height: 62px;
			width: 246px;
...
function pr_disable_admin_notices_2()
{
	global $wp_filter;
	if (is_user_admin()) {
...
add_action('admin_print_scripts', 'pr_disable_admin_notices_2');

function canhcam_embed()
{
